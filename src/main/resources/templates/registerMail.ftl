                ...
                <div>
                    ...
                    <span class="genEmailContent">
                        <div id="cTMail-Wrap"
                                        ...
                                        <td style="max-width:600px;">
                                            ...
                                            <div id="cTMail-logo" style="width:92px; height:25px;">
                                                ...
                                                <a href="">
                                                    ...
                                                    <img border="0" src="https://s1.ax1x.com/2022/05/03/OFxkaF.jpg"
                                                    ...
                                                    <tr style="font-weight:300">
                                                        ...
                                                        <td style="max-width:480px;text-align:left;">
                                                            ...
                                                            <h1 id="cTMail-title" style="font-size: 20px; line-height: 36px; margin: 0px 0px 22px;">
                                                                【所依】欢迎注册 <span style="color: #3485FB">所依</span>
                                                            </h1>
                                                            ...
                                                            <p class="cTMail-content" style="line-height: 24px; margin: 6px 0px 0px; overflow-wrap: break-word; word-break: break-all;">
                                                                <span style="color: rgb(51, 51, 51); font-size: 14px;">完成注册，请复制下面的验证码 验证邮箱。
                                                            ...
                                                            <p class="cTMail-content" style="line-height: 24px; margin: 6px 0px 0px; overflow-wrap: break-word; word-break: break-all;">
                                                                <span style="color: rgb(51, 51, 51); font-size: 14px;">
                                                                    ...
                                                                    无法正常显示？请复制链接至浏览器打开：
                                                                    <br>
                                                                    <a href="javascript:;" title="" id="hre"
                                                                       style="color: rgb(0, 164, 255); text-decoration: none; word-break: break-all; overflow-wrap: normal; font-size: 14px;" onclick="copy()">
						   ...
						   <p> 此致</p>
				  <strong style="display:block;margin-right:20px">--------------所依团队</strong></div>
                                                                    </p>
                                                                </dd>
                                                            </dl>
                                                        </td>
                                                    ...
                                                    <tr style="font-weight:300">
                                                        ...
                                                        <td style="max-width:540px;">
                                                            ...
                                                            <p id="cTMail-rights" style="max-width: 100%; margin:auto;font-size:12px;color:#999;text-align:center;line-height:22px;">
                                                                <img border="0" src="https://soe.icemomo.com/65ec1205b9853f910c1eb5a26f0b88b.jpg"
